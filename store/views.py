...
def store(request, category_slug=None):
    ...
    if category_slug != None:
        ...
        # Le nombre d'élément à afficher
    ...
    if request.method == 'POST':
        try:
            ...
            if form.is_valid():
                ...
                messages.error(request, 'Erreur lors de la mise à jour de votre avis.')
            ...
            if form.is_valid():
                ...
                messages.error(request, 'Erreur lors de la soumission de votre avis.')
